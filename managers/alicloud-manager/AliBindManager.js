...
class AliBindManager extends BaseManager {
  ...
  init() {
    ...
    return this.registerCrds(CONST.APISERVER.RESOURCE_GROUPS.BIND, 'apsarabinds')
      .then(() => this.registerWatcher(CONST.APISERVER.RESOURCE_GROUPS.BIND, 'apsarabinds', validStateList));
  }
