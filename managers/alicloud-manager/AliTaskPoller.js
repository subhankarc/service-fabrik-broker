...
class AliTaskPoller {
  static start() {
    function poller(object, intervalId) {
      ...
      return eventmesh.apiServerClient.getResource({
        ...
        .catch(err => {
          ...
          AliTaskPoller.clearPoller(object.metadata.name, intervalId);
        });
    }
    ...
    return eventmesh.apiServerClient.registerWatcher(CONST.APISERVER.RESOURCE_GROUPS.DEPLOYMENT, 'apsaras', startPoller, queryString)
      .then(stream => {
  ...
  static clearPoller(resourceId, intervalId) {
    ...
    _.unset(AliTaskPoller.pollers, resourceId);
  }
}

AliTaskPoller.pollers = [];
module.exports = AliTaskPoller;