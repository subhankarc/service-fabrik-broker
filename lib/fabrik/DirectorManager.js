  ...
  startBackup(opts) {
    ...
    return Promise
      ...
      .then(result => {
        ...
        return resourceManager.manager.updateAnnotationKey(this.name, opts.instance_guid, 'backup', 'default', result.backup_guid, 'result', JSON.stringify(resultValue))
      })
      .then(() => resourceManager.manager.updateAnnotationState(this.name, opts.instance_guid, 'backup', 'default', result.backup_guid, CONST.RESOURCE_STATE.SUCCEEDED))
      .catch(err => {
        return Promise
