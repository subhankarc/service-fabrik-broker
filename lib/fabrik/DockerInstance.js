...
class DockerInstance extends BaseInstance {
  ...
  create(params) {
    ...
    return this
      ...
      .catchThrow(DockerError.Conflict, new ServiceInstanceAlreadyExists(this.guid)) // TODO: Handle error state as well.
      ...
      .then(() => {
        ...
        return resourceManager.manager.updateResourceKey(this.manager.name, this.guid, 'result', JSON.stringify(resultValue))
      })
      .then(() => resourceManager.manager.updateResourceState(this.manager.name, this.guid, CONST.RESOURCE_STATE.SUCCEEDED));
  }
  ...
  bind(params) {
    ...
    return this
      .inspectContainer()
      .catchThrow(DockerError.NotFound, new ServiceInstanceNotFound(this.guid)) // TODO: Handle error state as well.
